...
const Images = () => {
  return (
    <>
      <div className="border-2 rounded-3xl mx-4 my-4 bg-zinc-800 border-orange-400">
        <div
        ...
        <div className="w-full h-[2px] bg-gradient-to-r from-transparent via-orange-500/60 to-transparent mb-2" />
        <div className="flex items-center justify-around flex-col md:flex-row gap-5 sm:gap-6 md:gap-10 lg:gap-2 py-5 sm:py-8  sm:px-7 md:px-7">
          <div className="border-2 h-fit flex flex-col gap-4 py-3 px-4 rounded-3xl bg-black border-orange-500">
